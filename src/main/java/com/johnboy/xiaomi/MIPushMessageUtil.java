...
public class MIPushMessageUtil {
    ...
    private Message buildMessageForAndroid(String title, String description, String messagePayload,
        ...
        Message.Builder builder = new Message.Builder()
                ...
                .extra("id","aaaa")
                .extra("schoolNo","sss")
                .extra("userNo","userno");;//可选项, 消息的生命周期, 若用户离线, 设置消息在服务器保存的时间, 单位: ms(服务器默认最长保留两周)
    ...
    public Result sendMessageToRegId(String title, String description,
                                     String messagePayload, Integer passThrough, Integer notifyType, List<String> alias, long timeToLive) {
    ...
    public static void main(String[] args) {
        MIPushMessageUtil util = new MIPushMessageUtil();
        util.sendMessageToRegId("title","description","messagePayload",1,-1, Arrays.asList("aa","cc","cc"),2000);
    }
}
