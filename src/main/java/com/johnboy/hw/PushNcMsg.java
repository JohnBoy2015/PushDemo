...
{
    private static String appSecret = "73f7935bb00ace9bbed675bafb3bb394";
    private static  String appId = "100393027";//用户在华为开发者联盟申请的appId和appSecret（会员中心->应用管理，点击应用名称的链接）
