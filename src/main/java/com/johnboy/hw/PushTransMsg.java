...
public class PushTransMsg
{
    ...
    private static  void sendPushMessage() throws IOException
    {
        ...
        body.put("title", "Push message content");//透传消息自定义body内容
        body.put("content", "Push message content");//透传消息自定义body内容
        body.put("id", "aaaa");//透传消息自定义body内容
        body.put("schoolNo", "xxxxxx");//透传消息自定义body内容
        body.put("userNo", "222222222222");//透传消息自定义body内容
